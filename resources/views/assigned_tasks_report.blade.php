...
<script type="text/javascript">
    ...
    function getAssignedTaskReport() {
        ...
        $.ajax({
            ...
            type:'POST',
            data: {_token:"{{csrf_token()}}", task_name: task_name_search, assigned_to: assigned_to, assigned_date_from: assigned_date_from, assigned_date_to: assigned_date_to, status: status},
            dataType: "html",
            success: function (data) {
