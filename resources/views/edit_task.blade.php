                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="task_description" name="task_description">{{ $task_info->task_description }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="date" id="delivery_date" name="delivery_date" required="required" value="{{ $task_info->reschedule_delivery_date }}" placeholder="YYYY-mm-dd" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="remarks" name="remarks">{{ $task_info->remarks }}</textarea>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="mb-3">
